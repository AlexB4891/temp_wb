...
presentes <- list.files("20250325/Tablas/params/") %>%
...
# 
saveWorkbook(wb, "20250325/Tablas/diccionario_ejecucion_temp.xlsx", overwrite = TRUE)

fechas <- c("20250325")

dicc_label <- read_excel("20250325/Tablas/diccionario_ejecucion_temp.xlsx") 
...
write_csv(procesamiento,"data/model_table_20250325.csv")
